...
class MyCNN(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(8, 8, kernel_size=3, stride=1, padding=1) # 8 input channels, 16 output channels, 3x3 convolution
        self.pool = nn.MaxPool2d(kernel_size=2, stride=2, padding=0) # 2x2 max pooling layer
        self.fc1 = nn.Linear(8 * 7 * 7, 32) # 16 channels, 7x7 after pooling
